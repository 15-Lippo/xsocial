...
Insights
Settings
social-w3/pages/[userId].js
@15-Lippo
15-Lippo Initial commit
…
 1 contributor
504 lines (464 sloc)  17 KB
                ...
                <Box sx={{ pb: 6 }}>
                    <Container maxWidth="sm" align="center">
                        ...
                        <Stack sx={{ pt: 2 }} direction="row" spacing={2} justifyContent="center">
                            <ColorTTF sx={{ width: '90%', mt: 1, mb: 1 }}
                                component="a"
                                label="Find and Mention Me on Twitter"
                                icon={<Twitter />}
                                variant="contained"
                                href={'https://twitter.com/' + socmed}
                                clickable
                            />
                        </Stack>
                        <Stack sx={{ pt: 1 }} direction="row" spacing={2} justifyContent="center">
                            <ColorInstagram sx={{ width: '90%', mt: 1, mb: 1 }}
                                component="a"
                                label="Find and Chat Me on Instagram"
                                icon={<Instagram />}
                                variant="contained"
                                href={'https://www.instagram.com/' + socmed}
                                clickable
                            />
                        </Stack>
                        <Stack sx={{ pt: 1 }} direction="row" spacing={2} justifyContent="center">
                            <ColorTTF sx={{ width: '90%', mt: 1, mb: 1 }}
                                component="a"
                                label="Find and Chat Me on Telegram"
                                icon={<Telegram />}
                                variant="contained"
                                href={'https://t.me/' + socmed}
                                clickable
                            />
                        </Stack>
                        <Stack sx={{ pt: 1 }} direction="row" spacing={2} justifyContent="center">
                            <ColorTTF sx={{ width: '90%', mt: 1, mb: 1 }}
                                component="a"
                                label="Find and Chat Me on Facebook"
                                icon={<Facebook />}
                                variant="contained"
                                href={'https://www.facebook.com/' + socmed}
                                clickable
                            />
                        </Stack>
                    </Container>
